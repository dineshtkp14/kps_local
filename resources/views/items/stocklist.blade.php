                        ...
                        @if ($itm->isNotEmpty())
                            @foreach ($itm as $i)
                                <tr>
                                    ...
                                    @if ($i->quantity >= 1)
                                        <td> <a href="{{ Route('items.getdata', $i->id) }}" class="btn w-50"
                                                rel="noopener noreferrer" style="background:#389AF5;color:white;">Sell</a>
                                        </td>
                                    @elseif($i->quantity == 0)
                                        <td> <a href="#" class="btn btn-secondary w-50"
                                                rel="noopener noreferrer">Order Now</a></td>
                                    @endif
                                </tr>
                            @endforeach
                        @else
